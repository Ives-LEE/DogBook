...
public class ActivityUpdateFragment extends Fragment {
    private final static String TAG = "ActivityUpdateFragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_activity_update, container, false);
        findViews(rootView);
        ...
        btFinishUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String activity_date = etActDate.getText().toString();
                String location_address = etAddress.getText().toString();
                List<Address> addressList;
                double location_latitude = 0.0;
                double location_longitude = 0.0;
                String content = etContent.getText().toString();
                try {
                    addressList = new Geocoder(getActivity()).getFromLocationName(location_address, 1);
                    location_latitude = addressList.get(0).getLatitude();
                    location_longitude = addressList.get(0).getLongitude();
                } catch (IOException e) {
                ...
                if (Common.networkConnected(getActivity())) {
                    ...
                    Activity newActivity = new Activity(activity.getId(), name, location_address, location_latitude, location_longitude, activity_date,content);
                    String imageBase64 = Base64.encodeToString(image, Base64.DEFAULT);
                    JsonObject jsonObject = new JsonObject();
                    jsonObject.addProperty("action", "activityUpdate");
                    jsonObject.addProperty("activity", new Gson().toJson(newActivity));
    ...
    private void dataBindViews() {
        ...
        if (bitmap != null) {
            ...
            ivActivity.setImageResource(R.mipmap.ic_launcher);
        }
        ivActivity.setImageBitmap(bitmap);
        tvId.setText(String.valueOf(id));
        etName.setText(activity.getName());
        etActDate.setText(activity.getActivity_date());
        etAddress.setText(activity.getLocation_address());
        etContent.setText(activity.getContent());
    }
